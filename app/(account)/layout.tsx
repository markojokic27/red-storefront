      ...
      <Layout className="mt:18 md:mt-21">
        <LayoutRow className="relative">
          <LayoutColumn
            span={12}
            lgSpan={3}
            className='pulled-background-account md:after top-18 sticky left-0 z-10 h-fit w-full before:absolute before:right-0 before:top-0 before:z-[-1] before:block before:h-full before:bg-grayscale-50 before:content-[""] after:absolute after:top-0 after:z-[-1] after:block after:h-full after:bg-grayscale-50 after:content-[""] md:top-21 lg:after:right-0'
          >
            <h2 className="mt-4 text-right text-lg font-black italic text-blue-700 md:mb-10 md:text-left lg:mb-16 lg:mt-24 lg:text-xl">
              My account
            </h2>
            <LayoutLinks />
            <Button variant="link" className="mb-8 ml-auto md:ml-0 lg:mb-16">
              Log out
            </Button>
          </LayoutColumn>
