export default function Page() {
  return (
    <div className="article mb-48 mt-44">
      ...
      <p>
        This Cookie Policy explains how Red Fashion Brand ("Red," "we," "us," or
        "our") uses cookies and similar technologies on our website. By using
        our website, you consent to the use of cookies as described in this
        policy.
      </p>
      <h2>1. What Are Cookies:</h2>
      <p>
        Cookies are small text files that are placed on your computer or device
        when you visit a website. They are widely used to make websites work
        more efficiently and provide a better browsing experience. Cookies also
        enable website owners to collect certain information about visitors.
      </p>
      ...
      <div>
        <ul>
          <li>
            ...
            operation of our website and enable you to navigate and use its
            features. They are typically set in response to your actions, such
            as setting your privacy preferences, logging in, or filling out
            forms.
          </li>
          <li>
            <b>Analytics and Performance Cookies:</b> These cookies help us
          ...
          <li>
            ...
            remember choices you make (such as language preferences) and provide
            enhanced features. They may also be used to provide personalized
            content based on your browsing history.
          </li>
          <li>
            <b>Advertising and Targeting Cookies:</b> These cookies are used to
      ...
      <p>
        ...
        web browsers allow you to block or delete cookies. However, please note
        that blocking or deleting certain cookies may impact the functionality
        and user experience of our website.
      </p>

      <p>
        For more information on how to manage cookies, you can visit the help or
