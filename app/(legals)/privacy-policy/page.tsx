export default function Page() {
  return (
    <div className="article mb-48 mt-44">
      ...
      <p>
        At Red Fashion Brand ("Red," "we," "us," or "our"), we value your
        ...
        your data when you interact with our website, services, and products. By
      ...
      <p>
        Additionally, we may automatically collect certain information when you
        access or use our website, including:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        analyze usage patterns and enhance user experience. You can manage your
      ...
      <p>
        ...
        without parental consent, we will take prompt action to delete such
        data.
      </p>
      ...
      <p>
        ...
        We will notify you of any material changes via email or by prominently
