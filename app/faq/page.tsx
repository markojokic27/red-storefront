          ...
          <Accordion.Item value="item1">
            ...
            <Accordion.Content className="accordion-content">
              <p className="mb-8">
                ...
                payment information, review your order, and confirm the
                purchase.
              </p>
            </Accordion.Content>
          </Accordion.Item>
          ...
          <Accordion.Item value="item3">
            ...
            <Accordion.Content className="accordion-content">
              <p className="mb-8">
                ...
                vary depending on your location and the selected shipping
                method. For detailed information, please visit our "Delivery and
                Returns" page.
              </p>
            </Accordion.Content>
          </Accordion.Item>
          <Accordion.Item value="item4">
            ...
            <Accordion.Content className="accordion-content">
              <p className="mb-8">
                ...
                email with a tracking number. You can easily track the progress
                of your delivery by entering the provided tracking number on our
          ...
          <Accordion.Item value="item5">
            ...
            <Accordion.Content className="accordion-content">
              <p className="mb-8">
                ...
                you need to return an item, please refer to our "Returns and
                Refunds" policy on our "Delivery and Returns" page for detailed
          ...
          <Accordion.Item value="item6">
            ...
            <Accordion.Content className="accordion-content">
              <p className="mb-8">
                ...
                the checkout process, you can enter your shipping address to
                check if your country is eligible for delivery.
              </p>
            </Accordion.Content>
          </Accordion.Item>
          <Accordion.Item value="item7" className="mb-26">
            ...
            <Accordion.Content className="accordion-content">
              <p className="mb-8">
                ...
                contact options, such as phone number, email address, or a
                contact form]. We are available [state working hours or response
                time] to assist you with any questions, concerns, or issues you
                may have.
              </p>
            </Accordion.Content>
          </Accordion.Item>
