  ...
  return (
    <LegalsLayout>
      <div className="article mb-48 mt-44">
        ...
        <p>
          Welcome to Red Fashion Brand ("Red," "we," "us," or "our"). These
          Terms of Use govern your access to and use of our website, products,
        ...
        <p>
          a. Eligibility: You must be at least 16 years old to use our website.
        ...
        <p>
          ...
          confidentiality of your account credentials and are solely responsible
        ...
        <ul>
          <li>
            ...
            harvesting any information from our website without our consent.
          </li>
          <li>
          ...
          <li>
            Collecting or harvesting any information from our website without
            our consent.
          </li>
        </ul>
        ...
        <p>
          ...
          with your use of our website or violation of these Terms of Use.
        </p>
        ...
        <p>
          ...
          website. Your continued use of our website after the changes
          constitutes your acceptance of the modified terms.
        </p>
        <h2>8. Governing Law and Jurisdiction:</h2>
        <p>
          These Terms of Use shall be governed by and construed in accordance
          with the laws of [Jurisdiction]. Any disputes arising out of or in
